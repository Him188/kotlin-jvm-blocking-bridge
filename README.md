...
2. **Install IntelliJ IDEA (or Android Studio) plugin**  
   ...
   One-key install: <iframe frameborder="none" width="245px" height="48px" src="https://plugins.jetbrains.com/embeddable/install/14816"></iframe>  
...
```kotlin
plugins {
  id("net.mamoe.kotlin-jvm-blocking-bridge") version "0.6.0"
}
```
